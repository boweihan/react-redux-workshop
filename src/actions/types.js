...
export const CHECK_OUT_DELETE_REQUEST = 'CHECK_OUTS_DELETE_REQUEST';
export const CHECK_OUT_DELETE_SUCCESS = 'CHECK_OUTS_DELETE_SUCCESS';
export const CHECK_OUT_DELETE_FAILURE = 'CHECK_OUTS_DELETE_FAILURE';
